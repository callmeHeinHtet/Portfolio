...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Sends via /api/contact — SMTP credentials stay server-side, never in the bundle.
      ...
      if (res.ok) {
        ...
        alert(data.error || 'Failed to send message. Please email heinhtetsoe1821@gmail.com directly.')
      }
    } catch (error) {
